const withPWA = require('next-pwa')({
  ...
  runtimeCaching: [
    // 🎯 CRITICAL: Cache navigation requests (HTML pages) for offline
    {
      urlPattern: /^https?.*\/$/i, // Match all HTML pages
    ...
    {
      urlPattern: /^https?:\/\/[^/]+\/[^/]*$/i, // Match root and routes
      handler: 'NetworkFirst',
      options: {
